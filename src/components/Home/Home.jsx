  ...
  return (
    <>
        ...
        <Container>
          <Row>
            <Col md={5} className='home-text-fisrt'>
              <h1 className='text-light fs-3'>{t('home.start')}</h1>
      ...
      <Container className='mt-5 home-fuel-wrapper' id='about-us'>
        <img
          src='/macsbg.webp'
          className='w-100 mt-5 position-relative'
          alt='MACS'
        />
        <Row className='home-bodygirl-info'>
          ...
          <Col md={6} className='my-auto'>
            <p
              dangerouslySetInnerHTML={{ __html: t('home.full_your_passion') }}
            />
          </Col>
        </Row>
      </Container>
      <div className='home-activities mt-5 text-center'>
        ...
        <div className='home-activities-wrapper'>
          <div className='position-relative'>
            <img
              src='/actividades1.webp'
              alt='fisicoconstructivismo'
              draggable='false'
            />
          ...
          <div className='position-relative'>
            <img
              src='/actividades2.webp'
              alt='activacion crosstraing zumba'
              draggable='false'
            />
            <p>{t('home.activity_2')}</p>
          </div>
          <div className='position-relative'>
            <img
              src='/actividades3.webp'
              alt='talleres y conferencias de nutrición y bienestar'
              draggable='false'
            />
            <p>{t('home.activity_3')}</p>
          </div>
          <div className='position-relative'>
            <img
              src='/actividades4.webp'
              alt='noche de adrenalina'
              draggable='false'
            />
            <p>{t('home.activity_4')}</p>
          </div>
          <div className='position-relative'>
            <img
              src='/actividades5.webp'
              alt='lanzamiento de startups hub'
              draggable='false'
            />
            <p>{t('home.activity_5')}</p>
          </div>
        </div>
      </div>
      <Container id='visitors'>
        <Row>
          <Col md={{ order: 1, span: 6 }} xs={{ order: 2 }} className='my-auto'>
            <p className='title_visitor'>{t('home.visitors')}</p>
            <p className='text_visitor'>{t('home.visitors_text')}</p>
          </Col>
      ...
      <Row className='m-0 bg-exhibitors' id='exhibitors'>
        ...
        <Col md={6} className='my-auto'>
          <p className='title_exhibitor'>{t('home.exhibitors')}</p>
          <p className='text_exhibitor'>{t('home.exhibitors_text')}</p>
        </Col>
      </Row>
